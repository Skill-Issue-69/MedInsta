    ...
    try:
        ...
        if user.role == "patient":
            try:
                ...
                user.delete()
                return Response({"error": "Valid date_of_birth (YYYY-MM-DD) required"}, status=400)
        ...
        return Response({"message": "Registration successful", "user_id": str(user.id)}, status=201)
